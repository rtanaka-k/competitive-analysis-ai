...
| 評価軸 | 競合スコア根拠 | 自社スコア根拠 |
|-------|--------------|--------------|
| 市場ポジション | [具体的な理由・データ] | [具体的な理由・データ] |
| 収益性 | [具体的な理由・データ] | [具体的な理由・データ] |
| ユーザー基盤 | [具体的な理由・データ] | [具体的な理由・データ] |
| ブランド力 | [具体的な理由・データ] | [具体的な理由・データ] |
| 技術力 | [具体的な理由・データ] | [具体的な理由・データ] |
...
| データ項目 | 出典 | 信頼性 |
|----------|------|--------|
| 市場規模 | [具体的なレポート名・ページ] | 高/中/低 |
| 売上推定 | [具体的な情報源] | 高/中/低 |
| DAU/MAU | [具体的な情報源] | 高/中/低 |
| CPI | [具体的な情報源] | 高/中/低 |
